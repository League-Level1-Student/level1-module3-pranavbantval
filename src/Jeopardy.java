...
public class Jeopardy implements ActionListener {
	...
	private void start() {
		...
		JPanel p = createHeader("Fill in the meme");
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if (buttonPressed == firstButton) {
			...
			askQuestion("Do you know da ___", "wae", 100);
		...
		// Or if the buttonPressed was the secondButton
			...
			askQuestion("Don't touch ma _______", "spaghet", 200);
			// Clear the button text (set the button text to nothing)
			secondButton.setText("");
		} else if (buttonPressed == thirdButton) {
			// Call the askQuestion() method with a harder question
			askQuestion("The last name of the president of the US elected in 2016", "Trump", 300);
			// Clear the button text (set the button text to nothing)
			thirdButton.setText("");
		} else if (buttonPressed == fourthButton) {
			// Call the askQuestion() method with a harder question
			askQuestion("Bye have a _____ ____", "great time", 400);
			// Clear the button text (set the button text to nothing)
